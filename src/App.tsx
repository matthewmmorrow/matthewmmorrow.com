...
function App() {
  ...
  const menu = (
    <Menu>
      ...
      <MenuList>
        <MenuItem onClick={() => scrollElement("background")}>Contact</MenuItem>
        <MenuItem onClick={() => scrollElement("skills")}>Skills</MenuItem>
        <MenuItem onClick={() => scrollElement("experience")}>Experience</MenuItem>
        <MenuItem onClick={() => scrollElement("education")}>Education</MenuItem>
      </MenuList>
    </Menu>
  );
  const contactIcons = (
    <>
      ...
      <a href={resume.linkedin} className="inline">
        <img className="h-6 w-6 m-0 invert inline" alt="linkedin" src="images/linkedin.png" />
      </a>
  ...
  return (
    <>
      <div className="fixed top-4 left-4 border border-white rounded">{menu}</div>
      ...
      <div id="personal-statement" className="prose max-w-none p-4">
        {resume.personalStatements.map((statement) => {
      ...
      <div id="bottom-bar" className="p-2 text-center bg-deep-orange-400">
        ...
        <small className="invert">
          <a
            href="https://github.com/matthewmmorrow/matthewmmorrow.com"
            className="flex justify-center content-center italic my-2"
          >
            <span>Made with TypeScript, ReactJS, and TailwindCSS</span>
            <img className="h-4 w-4 my-0 mx-1 invert inline" alt="github" src="images/github.png" />
          </a>
        </small>
      </div>
    </>
